...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Local SEO for Restaurants: How Google Reviews Affect Your Rankings (2026)",
    description:
      "Learn how local SEO for restaurants works in 2026, why your Google Business Profile matters, and how responding to Google reviews within 24 hours can directly improve your local search rankings.",
    url: "https://getmetafix.com/blog/local-seo-restaurants-google-reviews-2026",
    type: "article",
    publishedTime: "2026-03-20",
  },
  alternates: {
    canonical: "https://getmetafix.com/blog/local-seo-restaurants-google-reviews-2026",
  },
};

export default function LocalSeoRestaurantsPost() {
  return (
    <div className="min-h-screen bg-white">
      ...
      <main className="max-w-3xl mx-auto px-6 py-16">
        ...
        <div className="flex items-center gap-2 text-sm text-gray-400 mb-8">
          ...
          <span>/</span>
          <span className="text-gray-600 truncate">Local SEO for Restaurants</span>
        </div>
        ...
        <header className="mb-10">
          ...
          <p className="text-xl text-gray-500 leading-relaxed">
            Most restaurants are losing local search traffic to competitors not because of their food,
            but because of missing Google Business Profile optimisations and unanswered reviews. Here
            is what actually moves the needle in 2026.
          </p>
        </header>
        ...
        <article className="prose-content">
          ...
          <p className="text-gray-600 leading-relaxed mb-4">
            ...
            local SEO asset you control. If it is incomplete, inaccurate, or neglected, you are
            invisible to the customers searching for exactly what you offer.
          </p>
          ...
          <p className="text-gray-600 leading-relaxed mb-4">
            ...
            complete the fields that actually differentiate you in local search:
          </p>
          ...
          <p className="text-gray-600 leading-relaxed mb-4">
            Audit every directory listing your restaurant appears in. Make sure the name, address, and
            phone number match your Google Business Profile exactly, including formatting.
          </p>
          ...
          <p className="text-gray-600 leading-relaxed mb-4">
            Beyond the algorithmic signals, review responses influence click-through rate. When potential
            customers browse Google profiles, they read recent reviews and your responses. A professional,
            thoughtful reply to a 3-star review often converts a hesitant searcher more effectively than
            a wall of 5-star reviews with no owner engagement.
          </p>
          ...
          <p className="text-gray-600 leading-relaxed mb-4">
            For positive reviews: thank the customer by name, mention a specific detail from their
            review to show you read it, and include a soft invitation to return. Keep it under 100 words.
          </p>
          <p className="text-gray-600 leading-relaxed mb-4">
            For negative reviews: acknowledge the experience without being defensive, apologise
            genuinely, and offer to resolve the issue offline (include a direct contact method). Never
          ...
          <ul className="list-disc list-inside space-y-1 my-4 ml-4">
            <li className="text-gray-600 mb-1 ml-4 list-disc">Google Business Profile is 100% complete with accurate categories, attributes, and description</li>
            <li className="text-gray-600 mb-1 ml-4 list-disc">NAP is consistent across all directories and your own website</li>
            <li className="text-gray-600 mb-1 ml-4 list-disc">At least 50 photos uploaded (aim for 100+)</li>
            <li className="text-gray-600 mb-1 ml-4 list-disc">Posting regular Google Business Profile updates (weekly is ideal)</li>
            <li className="text-gray-600 mb-1 ml-4 list-disc">Actively asking satisfied customers for reviews (in-person, via receipt QR code, or post-visit email)</li>
            <li className="text-gray-600 mb-1 ml-4 list-disc">Responding to every review within 24 hours</li>
            <li className="text-gray-600 mb-1 ml-4 list-disc">Website includes LocalBusiness schema markup with opening hours, address, and cuisine type</li>
            <li className="text-gray-600 mb-1 ml-4 list-disc">Location-specific landing page on your website with embedded Google Map</li>
          </ul>
