...
export const posts: Post[] = [nextjsMetaTagsPost, wixMetaTagsPost, squarespaceMetaTagsPost, ecommerceSeoChecklistPost, altTextPost, robotsTxtPost, shopifyPost, ogPost, seoAuditPost, metaDescPost, wordpressMetaPost, titleTagLengthPost, canonicalTagPost, twitterCardPost, facebookPreviewPost, schemaMarkupPost, duplicateMetaDescriptionsPost];
