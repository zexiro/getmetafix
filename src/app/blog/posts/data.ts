...
export const posts: Post[] = [shopifySeoChecklistPost, googleBusinessProfileSeoPost, propertyManagementSeoPost, woocommerceMetaTagsPost, nextjsMetaTagsPost, wixMetaTagsPost, squarespaceMetaTagsPost, ecommerceSeoChecklistPost, altTextPost, robotsTxtPost, shopifyPost, ogPost, seoAuditPost, metaDescPost, wordpressMetaPost, titleTagLengthPost, canonicalTagPost, twitterCardPost, facebookPreviewPost, schemaMarkupPost, duplicateMetaDescriptionsPost, webflowMetaTagsPost, googleReviewsPost];
