...
export const metadata: Metadata = {
  title: "Google Business Profile Reviews: The Strategy That Gets More 5-Stars | GetMetaFix",
  description: "Google Business Profile Reviews: The Strategy That Gets More 5-Stars — practical guide with actionable steps for business owners and developers.",
  openGraph: {
    title: "Google Business Profile Reviews: The Strategy That Gets More 5-Stars",
    description: "Google Business Profile Reviews: The Strategy That Gets More 5-Stars — practical guide with actionable steps for business owners and developers.",
    url: "https://getmetafix.com/blog/google-business-profile-reviews-strategy",
    type: "article",
    publishedTime: "2026-03-21",
  },
  alternates: {
    canonical: "https://getmetafix.com/blog/google-business-profile-reviews-strategy",
  },
};
...
const articleSchema = {
  ...
  "@type": "Article",
  headline: "Google Business Profile Reviews: The Strategy That Gets More 5-Stars",
  description: "Google Business Profile Reviews: The Strategy That Gets More 5-Stars — practical guide with actionable steps for business owners and developers.",
  ...
  mainEntityOfPage: {
    "@type": "WebPage",
    "@id": "https://getmetafix.com/blog/google-business-profile-reviews-strategy",
  },
};

export default function GoogleBusinessProfileReviewsStrategy() {
  return (
    <div className="min-h-screen bg-white">
      ...
      <main className="max-w-3xl mx-auto px-6 py-16">
        ...
        <div className="flex items-center gap-2 text-sm text-gray-400 mb-8">
          ...
          <span>/</span>
          <span className="text-gray-600 truncate">Google Business Profile Reviews: The Strategy That Gets More 5-Stars</span>
        </div>

        {/* Header */}
        <header className="mb-12">
          <h1 className="text-3xl font-bold text-gray-900 mb-4 leading-tight">
            Google Business Profile Reviews: The Strategy That Gets More 5-Stars
          </h1>
...
<h2>Tools to Automate Your Review Strategy</h2>
