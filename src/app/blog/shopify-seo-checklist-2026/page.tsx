...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://getmetafix.com/blog/shopify-seo-checklist-2026",
  },
};
...
const articleSchema = {
  ...
  mainEntityOfPage: {
    "@type": "WebPage",
    "@id": "https://getmetafix.com/blog/shopify-seo-checklist-2026",
  },
};

export default function ShopifySeoChecklist2026() {
  return (
    <div className="min-h-screen bg-white">
      ...
      <main className="max-w-3xl mx-auto px-6 py-16">
        ...
        <div className="flex items-center gap-2 text-sm text-gray-400 mb-8">
          ...
          <span>/</span>
          <span className="text-gray-600 truncate">Shopify SEO Checklist 2026</span>
        </div>
        ...
        <header className="mb-10">
          ...
          <h1 className="text-4xl font-bold text-gray-900 leading-tight mb-4">
            Shopify SEO Checklist 2026: Fix Every Issue in Under 2 Hours
          </h1>
        ...
        <article className="prose-content">
          ...
          <p className="text-gray-600 leading-relaxed mb-4">
            The reason is not negligence. It is that Shopify handles enough for most merchants to
            feel confident their SEO is fine, while quietly leaving dozens of issues unaddressed.
            The platform generates title tags automatically. It creates a sitemap. It has canonical
            tags baked into themes. None of that means your SEO is correct.
          </p>
          <p className="text-gray-600 leading-relaxed mb-4">
          ...
          <ul className="list-disc list-inside space-y-1 my-4 ml-4">
            <li className="text-gray-600 mb-1 ml-4 list-disc">
              <strong className="font-semibold text-gray-900">78% of product pages</strong> have
              auto-generated title tags that exceed 60 characters or bury the primary keyword
            </li>
            <li className="text-gray-600 mb-1 ml-4 list-disc">
              <strong className="font-semibold text-gray-900">65% of stores</strong> have missing
              or duplicate meta descriptions across collection and product pages
            </li>
            <li className="text-gray-600 mb-1 ml-4 list-disc">
              <strong className="font-semibold text-gray-900">72% of stores</strong> have no
              og:image set on product pages, meaning social shares show broken or random previews
            </li>
            <li className="text-gray-600 mb-1 ml-4 list-disc">
              <strong className="font-semibold text-gray-900">81% of stores</strong> have no
              Product schema markup, missing out on rich result eligibility in Google
            </li>
            <li className="text-gray-600 mb-1 ml-4 list-disc">
              <strong className="font-semibold text-gray-900">Core Web Vitals failures</strong> on
              mobile affect over 60% of Shopify stores due to unoptimised theme images and
          ...
          <p className="text-gray-600 leading-relaxed mb-4">
            Meta tags are the highest-leverage SEO fixes on any Shopify store. They directly
            control your Google search result appearance, your social share previews, and how
            crawlers understand your page intent.
          </p>
          ...
          <p className="text-gray-600 leading-relaxed mb-4">
            ...
            <code className="bg-gray-100 text-gray-800 px-1.5 py-0.5 rounded text-sm font-mono">Product Name | Shop Name</code>.
          ...
          <p className="text-gray-600 leading-relaxed mb-4">
            ...
            an HTTPS URL will be silently ignored.
          </p>
          ...
          <p className="text-gray-600 leading-relaxed mb-4">
            ...
            on all product and collection pages. This renders a full-width product image above the
            link title on X (formerly Twitter), which drives dramatically higher click-through
            rates than the compact{" "}
          ...
          <p className="text-gray-600 leading-relaxed mb-4">
            ...
            <code className="bg-gray-100 text-gray-800 px-1.5 py-0.5 rounded text-sm font-mono">og:image</code>{" "}
            to{" "}
            <code className="bg-gray-100 text-gray-800 px-1.5 py-0.5 rounded text-sm font-mono">twitter:image</code>.
            Set both explicitly. Use the same image URL. Two lines in your Liquid template, and
            you guarantee correct rendering on both Twitter/X and Open Graph platforms.
          </p>
          ...
          <p className="text-gray-600 leading-relaxed mb-4">
            Set{" "}
            <code className="bg-gray-100 text-gray-800 px-1.5 py-0.5 rounded text-sm font-mono">og:type</code>{" "}
            to{" "}
            <code className="bg-gray-100 text-gray-800 px-1.5 py-0.5 rounded text-sm font-mono">product</code>{" "}
            on product pages. This unlocks richer Facebook preview formats for ecommerce. Use{" "}
            <code className="bg-gray-100 text-gray-800 px-1.5 py-0.5 rounded text-sm font-mono">website</code>{" "}
            on your homepage and{" "}
            <code className="bg-gray-100 text-gray-800 px-1.5 py-0.5 rounded text-sm font-mono">article</code>{" "}
            on blog posts. Leaving{" "}
            <code className="bg-gray-100 text-gray-800 px-1.5 py-0.5 rounded text-sm font-mono">og:type</code>{" "}
            unset defaults to{" "}
            <code className="bg-gray-100 text-gray-800 px-1.5 py-0.5 rounded text-sm font-mono">website</code>,
            which means you lose the product-specific Open Graph fields.
          </p>
          ...
          <p className="text-gray-600 leading-relaxed mb-4">
            ...
            meaningful organic traffic. Mention product count, price range, or a standout feature.
          </p>
          ...
          <p className="text-gray-600 leading-relaxed mb-4">
            Technical SEO controls how Google crawls, indexes, and interprets your Shopify store.
            Get this wrong and even perfect meta tags will not save your rankings.
          </p>
          ...
          <p className="text-gray-600 leading-relaxed mb-4">
            ...
            <code className="bg-gray-100 text-gray-800 px-1.5 py-0.5 rounded text-sm font-mono">/products/product-name</code>{" "}
            and{" "}
            <code className="bg-gray-100 text-gray-800 px-1.5 py-0.5 rounded text-sm font-mono">/collections/collection-name/products/product-name</code>.
            Both are live, indexable, and identical in content. Without a canonical tag on the
          ...
          <p className="text-gray-600 leading-relaxed mb-4">
            ...
            for any &ldquo;blocked by robots.txt&rdquo; errors on key pages.
          </p>
          ...
          <p className="text-gray-600 leading-relaxed mb-4">
            ...
            <code className="bg-gray-100 text-gray-800 px-1.5 py-0.5 rounded text-sm font-mono">yourdomain.com/sitemap.xml</code>{" "}
            automatically. It includes products, collections, pages, and blog posts. What it does
            not do is submit itself. Log into Google Search Console, go to Sitemaps, and submit
            your sitemap URL. Verify the indexed URL count is close to your actual page count. If
            Google shows significantly fewer indexed pages than you expect, you have a crawl or
            canonicalization problem worth investigating.
          </p>
          ...
          <p className="text-gray-600 leading-relaxed mb-4">
            ...
            your theme&apos;s{" "}
            <code className="bg-gray-100 text-gray-800 px-1.5 py-0.5 rounded text-sm font-mono">product.json</code>{" "}
            template via a{" "}
            <code className="bg-gray-100 text-gray-800 px-1.5 py-0.5 rounded text-sm font-mono">&lt;script type=&quot;application/ld+json&quot;&gt;</code>{" "}
            block.
          </p>
          ...
          <p className="text-gray-600 leading-relaxed mb-4">
            ...
            hierarchy without setting up a redirect, you create a 404. 404 pages waste crawl budget,
            break backlinks, and confuse users. In Shopify, go to{" "}
            <strong className="font-semibold text-gray-900">Online Store &rarr; Navigation &rarr; URL Redirects</strong>{" "}
            and set up 301 redirects for every deleted or moved page. Also pull a crawl report from
            Google Search Console &rarr; Pages &rarr; Not Found (404) at least once a month.
          </p>
          ...
          <p className="text-gray-600 leading-relaxed mb-4">
            ...
            WhyNoPadlock to check for mixed content issues.
          </p>
          ...
          <p className="text-gray-600 leading-relaxed mb-4">
            ...
            <code className="bg-gray-100 text-gray-800 px-1.5 py-0.5 rounded text-sm font-mono">&lt;meta name=&quot;robots&quot; content=&quot;noindex&quot;&gt;</code>{" "}
            to prevent indexation during development, then forgets to remove it before launch. Or
            a theme update reintroduces it. Run a site: search on Google for your domain. If you
            expect 500 pages indexed and see 50, you have a noindex problem. Verify the tag is
            absent on your top 10 pages by viewing page source and searching for &ldquo;noindex&rdquo;.
          </p>
          ...
          <p className="text-gray-600 leading-relaxed mb-4">
            On-page content signals reinforce your meta tag work. These are the elements Google
            uses to understand topical relevance beyond what is in your{" "}
            <code className="bg-gray-100 text-gray-800 px-1.5 py-0.5 rounded text-sm font-mono">&lt;head&gt;</code>.
          </p>
          ...
          <p className="text-gray-600 leading-relaxed mb-4">
            ...
            to an empty alt attribute unless you fill it in manually. Alt text serves two purposes:
          ...
          <p className="text-gray-600 leading-relaxed mb-4">
            ...
            Do not change handles on live products that already have backlinks without setting up
            a 301 redirect.
          </p>
          ...
          <p className="text-gray-600 leading-relaxed mb-4">
            ...
            On product pages this means using H2 for major sections (Features, Sizing, Reviews)
            and H3 for subsections. On collection pages, use H2 for any editorial copy below the
            product grid. Google uses heading structure to understand what a page covers. A page
            with no subheadings and 800 words of body text is harder to parse than one with
          ...
          <p className="text-gray-600 leading-relaxed mb-4">
            ...
            attributes to script tags where possible. For apps injected via Shopify&apos;s Script Tags
            API, check if the app provides a &ldquo;load after page ready&rdquo; option in its settings.
            Shifting even 200ms of JavaScript load time post-render can move your Largest
            Contentful Paint (LCP) score significantly.
          </p>
          ...
          <p className="text-gray-600 leading-relaxed mb-4">
            ...
            correct sizing parameters rather than being loaded at full resolution and
            scaled down in CSS.
          </p>
          ...
          <p className="text-gray-600 leading-relaxed mb-6">
            ...
            completed in under 2 hours for a typical Shopify store.
          </p>

          <div className="bg-gray-50 border border-gray-200 rounded-xl p-6 mb-6">
            <h3 className="text-base font-bold text-gray-900 mb-4">Meta Tags</h3>
            <ul className="space-y-2">
              {[
                ...
                <li key={item} className="flex items-start gap-3 text-sm text-gray-600">
                  <span className="mt-0.5 w-4 h-4 rounded border border-gray-300 bg-white flex-shrink-0 inline-block" />
                  {item}
                </li>
              ))}
            </ul>
          ...
          <div className="bg-gray-50 border border-gray-200 rounded-xl p-6 mb-6">
            <h3 className="text-base font-bold text-gray-900 mb-4">Technical SEO</h3>
            <ul className="space-y-2">
              {[
          ...
          <div className="bg-gray-50 border border-gray-200 rounded-xl p-6 mb-6">
            <h3 className="text-base font-bold text-gray-900 mb-4">Content and Pages</h3>
            <ul className="space-y-2">
              {[
          ...
          <div className="bg-gray-50 border border-gray-200 rounded-xl p-6 mb-6">
            <h3 className="text-base font-bold text-gray-900 mb-4">PageSpeed</h3>
            <ul className="space-y-2">
              {[
