...
<meta name="description" content="Shop our full range of products. Free delivery over £50.">`}</code></pre>
          ...
          <ul className="list-disc list-inside space-y-1 my-4 ml-4">
            ...
            <li className="text-gray-600 mb-1 ml-4 list-disc">Filter by <strong className="font-semibold text-gray-900">Duplicate</strong> and you&apos;ll see every page sharing an identical description</li>
          </ul>
